...
import { CalculatedColumn, Column, Filters, Position, RowRendererProps, Dictionary, FillEvent, PasteEvent } from './types';
...
declare const _default: <R, SR = unknown>(props: DataGridProps<R, SR> & React.RefAttributes<DataGridHandle>) => JSX.Element;
